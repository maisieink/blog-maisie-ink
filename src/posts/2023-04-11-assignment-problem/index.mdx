...
description: "A while ago, I was working on a proof-of-concept app where you could group cards into clusters on a free-form board. I used the Hungarian algorithm to maintain cluster color mappings."
...
- Make dark mode look better, double check colors
- Add alt text to images
- Proofread and verify tables and images
